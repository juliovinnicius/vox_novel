...
void main() {
  ...
  test('watchAll emits every book once in deterministic newest-first order', () async {
  ...
  test('replacement preserves identity and metadata while updating import fields', () async {
  ...
  test('metadata update trims values and changes only metadata and updatedAt', () async {
  ...
  test('failed replacement rolls back without an intermediate stream emission', () async {
    final first = fixture(id: 'book-1', hash: 'hash-1');
    final second = fixture(id: 'book-2', hash: 'hash-2');
    await repository.insert(first);
    await repository.insert(second);
